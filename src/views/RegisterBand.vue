...
export default {
  ...
  data() {
    return {
      ...
      items: [
        {
          text: 'Single artist', value: 'single',
  ...
  methods: {
    onChange(){
      if(this.item === 'single'){
        this.label = 'Name of artist'
      }else{
        this.label = 'Name of group'
      }
    },
    selectpic(e) {
    ...
    async uploadProduct() {
      ...
      try {
        ...
        container.append("property", 'Band(music)');
        container.append("name", this.name);
        container.append("price", this.price);
        container.append("artistTYpe", this.item);
        container.append("artistDescription", this.details);
        container.append("experience", this.experience);
