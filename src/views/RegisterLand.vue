      ...
      <v-col cols="12" sm="9" md="10" lg="10" class="mx-auto">
        <v-row>
          ...
          <v-col cols="12" sm="12" md="6" lg="6" class="content-wrap pl-md-6">
            ...
            <v-text-field prepend-icon="add" v-model="upi" label="UPI"></v-text-field>
            <v-text-field prepend-icon="add" v-model="area" :label="$t('message.landArea')"></v-text-field>
            <v-text-field prepend-icon="add" v-model="location" :label="$t('message.landLocation')"></v-text-field>
  ...
  methods: {
    ...
    async uploadProduct() {
      ...
      try {
        ...
        container.append("property", 'Land');
        container.append("name", this.name);
        container.append("price", this.price);
        container.append("upi", this.upi);
        container.append("area", this.area);
        container.append("location", this.location);
