<template>
  <div class="feature-product-wrap section-gap title-gap">
    <div class="containevr">
      <div class="filter d-flex align-content-space-between">
        <v-btn style="margin-left: 10px" color="#ff7d00" @click="getRentalByCategory">
...
export default {
  ...
  async mounted() {
    try {
      const res = await rent.getRentalByCategory({ category: "land" });
