          ...
          <div class="layout align-center justify-center">
            <v-flex xs12 md8 lg6 xl6>
              <div class="emb-card pa-6 thankyou-block white pa-6 text-center">
                ...
                <h4 class="px-6 pb-2 text-center">Thank you for registering on our platform we pledge you connect you with employee not only here in rwanda but globally</h4>
