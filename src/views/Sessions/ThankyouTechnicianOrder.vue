          ...
          <div class="layout align-center justify-center">
            <v-flex xs12 md8 lg6 xl6>
              <div class="emb-card pa-6 thankyou-block white pa-6 text-center">
                ...
                <h4 class="px-6 pb-2 text-center">Thank you for putting trust in us and our technicians, we pledge you a good service through our competent technicians</h4>
...
<script>
import verify from "Api/Technician.js";
export default {
  methods: {},
  async mounted() {
    try {
      ...
      await verify.verifyPaymentTechOrder({
