          ...
          <div class="layout align-center justify-center">
            <v-flex xs12 md8 lg6 xl6>
              <div class="emb-card pa-6 thankyou-block white pa-6 text-center">
                ...
                <h4 class="px-6 pb-2 text-center">Thank you for using our Byizewe drycleaner service your clothes will be picked in few minutes. Thank you once again for working with us</h4>
...
<script>
import verify from "Api/DryCleaner.js";
export default {
  methods: {},
  async mounted() {
    try {
