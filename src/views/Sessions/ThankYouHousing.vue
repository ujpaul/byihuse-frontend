          ...
          <div class="layout align-center justify-center">
            <v-flex xs12 md8 lg6 xl6>
              <div class="emb-card pa-6 thankyou-block white pa-6 text-center">
                ...
                <h4 class="px-6 pb-2 text-center">Thank you for using our Byiza service you will never regret to work with us, our aim is to make you settle in good house through our service</h4>
...
<script>
import verify from "Api/Housing.js";
export default {
  methods: {},
  async mounted() {
    try {
