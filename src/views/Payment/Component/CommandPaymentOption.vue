    ...
    async makePayment(option) {
      ...
      try {
        ...
        if (this.valid) {
          ...
          const storageData = localStorage.getItem('installment');
          ...
          this.invoiceData = {
            ...
            totalAmmount: dataObj.price,
            installment: dataObj.type,
            products: this.product,
            delivery: this.shipping,
            discount: this.calculateDiscount(),
            // subTotal: this.itemTotal()
            subTotal: dataObj.price,
          };
          console.log(this.invoiceData);
          const res = await order.commandOrder(this.invoiceData);
