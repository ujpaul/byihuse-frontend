      ...
      <v-col cols="12" sm="9" md="10" lg="10" class="mx-auto">
        <v-row>
          ...
          <v-col cols="12" sm="12" md="6" lg="6" class="content-wrap pl-md-6">
            ...
            <v-text-field prepend-icon="add" v-model="name" :label="$t('message.houseName')"></v-text-field>
            <v-select prepend-icon="add" v-model="type" :label="$t('message.houseType')" :items="types"></v-select>
            <v-text-field prepend-icon="add" v-model="roadNumber" :label="$t('message.roadNumber')"></v-text-field>
            <v-text-field prepend-icon="add" v-model="gateNumber" :label="$t('message.gateNumber')"></v-text-field>
            <v-text-field
              prepend-icon="add"
              v-model="price"
              class="price-input"
  ...
  methods: {
    ...
    async uploadProduct() {
      ...
      try {
        ...
        container.append("property", 'House');
        container.append("name", this.name);
        container.append("price", this.price);
        container.append("roadNumber", this.roadNumber);
        container.append("gateNumber", this.gateNumber);
